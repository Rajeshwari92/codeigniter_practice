    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="panel-title">CRUD GET method REST API in Codeigniter</h3>
                    </div>
...
$(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.error)
                {
                    ...
                    $('#location_error').html(data.location_error);
                }
            }
        })
    });
    ...
    $(document).on('click', '.edit', function(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>test_api/action",
            method:"POST",
            data:{person_id:person_id, data_action:'fetch_single'},
            dataType:"json",
            success:function(data)
            {
                $('#userModal').modal('show');
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Are you sure you want to delete this?"))
        {
            $.ajax({
                url:"<?php echo base_url(); ?>test_api/action",
                method:"POST",
                data:{person_id:person_id, data_action:'Delete'},
                dataType:"JSON",
                success:function(data)
                {
                    if(data.success)
